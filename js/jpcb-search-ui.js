...
const plateEl=document.getElementById('searchFoundPlate');
const infoEl=document.getElementById('searchFoundInfo');
if(plateEl)plateEl.textContent=String(plate).toUpperCase();
...
// Jangan membuka detail / memanggil API lagi.
// Hasil pencarian cukup ditampilkan dan kartu unit di-board di-highlight.
window.searchFoundTimer=setTimeout(()=>ov.classList.remove('show'),2200);
}
